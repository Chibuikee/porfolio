...
Email: sopewenike@yahoo.com
 GitHub: Chibuikee
 LinkedIn: Chibuike Ewenike
 Portfolio: https://www.bytealpha.online

PROFESSIONAL SUMMARY
Highly adaptable Software Engineer with strong expertise in Python and javascript based backend systems, cloud deployments, and fullstack product development. Proven experience building and maintaining production-grade SaaS platforms, including AI-driven systems, e-commerce and e-learning platforms, legal-tech, financial, and booking applications.
Comfortable owning features end-to-end from system design and API development to cloud deployment and performance optimization. Thrives in fast-paced startup and scale-up environments. Passionate about building software that solves real-world problems.
...
Lexanalytics is an AI-powered legal research and analytics software.
...
Collaborated with cross-functional teams to translate complex legal workflows into scalable software solutions.
...
Redeployed and stabilized both backend and frontend services after cleanup and feature additions.
...
Collaborated on end-to-end feature stabilization—from database logic and backend services to frontend behavior—prioritizing production readiness, security, and long-term maintainability.
...
Strengthened backend APIs, auth, cron jobs, and notification services; shipped production fixes and performance optimizations.
...
Handled DevOps tasks including server provisioning and production deployments.
Tech: Python, AWS, Linux, AI models
...
Implemented and maintained backend features for payments, transactions, cron jobs, and webhooks to support ongoing operations.


Tech: JavaScript, TypeScript, Next.js, React, Node.js/Express, MongoDB, Redis, Stripe, Docker, Tailwind CSS


SELECTED PROJECTS
Lexanalytics — AI-powered legal research, analytics & contract automation https://www.lexanalytics.ai/
DanceDeal Training Foundation — Online training & registration platform https://dancedeal.org/
Dancerapy — Dance fitness video streaming platform https://dancerapy.org/
Nuvoro — Appointment booking & payment system for service businesses https://nuvoro.net
Stalwartblue — Enterprise capital & funding management portal to loans. https://opticap.stalwartblue.com/
GrowthClub — Enterprise capital & funding management portal https://growthclub.life
